...
require("packer").startup(function(use)
	...
	use({
		...
		branch = "master",
		commit = "17efb4c834daf4eea96f18753541485ed05baa6e",
		requires = "kyazdani42/nvim-web-devicons",
		config = function()
	...
	use({
		...
		branch = "master",
		commit = "41a097d9c543851625626618b08fc2bdf37b2894",
		run = ":TSUpdate",
		event = "BufRead",
		config = function()
	...
	use({
		...
		branch = "main",
		commit = "288c4582f62f04944412acaed098fc16a1818464",
		requires = {
			"nvim-lua/plenary.nvim",
			"lewis6991/gitsigns.nvim",
		},
	...
	use({
		...
		branch = "master",
		commit = "37edd90592ef0e4b603634e449ce28b053d9bdd0",
	})
	use({
		"williamboman/nvim-lsp-installer",
		branch = "main",
		commit = "ba47498582ac1021ec7f3caada039e22ca16dd05",
	})
	use({
		"hrsh7th/nvim-cmp",
		branch = "main",
	...
	use({
		...
		branch = "main",
		commit = "9f04462bcabfd108341a6e47ed742b09a6a5b975",
	})
	use({
	...
	use({
		"windwp/nvim-autopairs",
		branch = "master",
		commit = "5348e4a778ebdf42126a54fb5a933a98612df6cb",
		config = function()
	...
	use({
		...
		branch = "master",
		commit = "bc5c2f5658821f98e55013eb3bec9d540c420470",
	...
	use({
		...
		branch = "main",
		commit = "2cc567615b4889a7fd3db502b42f9207e8cab6f1",
	})
	use({
		"lervag/vimtex",
		tag = "v2.8",
