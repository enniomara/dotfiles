...
require("packer").startup(function(use)
	...
	use({
		...
		branch = "master",
		commit = "6ad1176e392c7a75e47eaf933fdbd0166f3e89da",
		run = ":TSUpdate",
		event = "BufRead",
		config = function()
	...
	use({
		...
		branch = "master",
		commit = "2837cd67ccdc50b7c7fe5a6a8cb0ca8cc6e2aae3",
	...
	use({
		...
		branch = "master",
		commit = "c55e830aa18bd15f36f7534947ec7471f2b43af7",
		event = { "VimEnter" },
	})
	use({
		"williamboman/nvim-lsp-installer",
		branch = "main",
		commit = "f4a4c066080a8b4724f40712b7768326702b6899",
	...
	use({
		...
		branch = "main",
		commit = "adedd98f125d7507a1306cbbc8ec658aa29396db",
	})
end)
